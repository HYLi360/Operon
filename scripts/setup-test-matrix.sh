...
# Create the uv-managed CPython 3.10-3.15 interpreters and one venv per version
# for run-test-matrix.sh.
#
# Everything stays inside .matrix/ so the repository itself is untouched.
#

...
本目录中的文档均以中文编写，并已按当前代码库（`operon` 0.5.1、数据库内部 schema 2.6、metadata schema 1.4、pytest 测试套件）重新核对。
...
| [How-to 操作手册](howto.md) | 日常使用者 | 针对具体任务的步骤：NCBI Datasets 导入/下载、批量元数据、归档测序数据、扩展 schema、外部 QC、profile、发布、备份与排错 |
| [NCBI adapter 恢复与迁移手册](ncbi-recovery-migration.md) | 旧数据库维护者 | 停写、只读基线、备份、schema 2.6 迁移、补偿式修复、验收、恢复下载与回退步骤 |

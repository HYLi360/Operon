...
This documentation matches `operon` 0.6.0, database schema 2.7, and metadata schema 1.4. The Chinese and English documentation use the same directory structure.
